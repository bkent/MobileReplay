...
import com.cytedesign.mobilereplay.gles.EglCore;
import com.cytedesign.mobilereplay.gles.FullFrameRect;
import com.cytedesign.mobilereplay.gles.Texture2dProgram;
import com.cytedesign.mobilereplay.gles.WindowSurface;
...
public class ContinuousCaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static final int REPLAY_LENGTH_SECONDS = 15;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            mCircEncoder = new CircularEncoder(VIDEO_WIDTH, VIDEO_HEIGHT, 6000000,
                    mCameraPreviewThousandFps / 1000, REPLAY_LENGTH_SECONDS, mHandler);
        } catch (IOException ioe) {
            throw new RuntimeException(ioe);
        }
    ...
    private String getFileName(){
        ...
        return DateToStr + ".mp4";
    }

    private void updateFileName(){
        File curFile = new File(getFilesDir(), getFileName());
        mOutputFile = curFile;
    }
