...
public class PlayMovieActivity extends Activity implements OnItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Arrays.sort(mMovieFiles, Collections.reverseOrder());
    ...
    public void clickPlayStop(@SuppressWarnings("unused") View unused) {
        ...
        if (mShowStopLabel) {
            ...
            mTextureView.setVisibility(unused.VISIBLE);
            if (mPlayTask != null) {
    ...
    private void updateControls() {
       ...
       // check.setEnabled(!mShowStopLabel);
        CheckBox check = (CheckBox) findViewById(R.id.loopPlayback_checkbox);
        check.setEnabled(!mShowStopLabel);
    }
    ...
    public void deleteSelected(View view){
        ...
        File file = new File(getFilesDir(), mMovieFiles[mSelectedMovie]);
        file.delete();
        repopulateSpinner();
    }

    public void uploadSelected(View view){
        String str = getString(R.string.not_implemented);
